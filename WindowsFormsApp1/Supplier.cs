...
namespace WindowsFormsApp1
{
    class Supplier
    {
        ...
        public static DataSet getSupplierOrders(DataSet ds, string search)
        {
            ...
            //define Sql Command
            String strSQL = "Select SupplierId,SupplierName,Balance,Status From Supplier Where SupplierName LIKE '" + search.ToUpper() + "%'";
